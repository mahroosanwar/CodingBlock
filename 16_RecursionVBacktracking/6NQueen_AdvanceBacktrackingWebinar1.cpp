...
//method 2 (using void function) --> to print all posssible outcome
...
//void fun will go through all he possible outcomes
// to count the total ans
int ans = 0;
void solve_N_Queen(int board[][10], int i, int n){        //i --> current rows, n --> no of queens
    //base case
    if(i == n){
...
int main(){
    ...
    cout << endl << "total no. of outcomes possible!: " << ans;
    return 0;
}