...
//Shortest Distance Between Nodes Of A Binary Tree
//use lca function above
//cfinding the level of a given node from the root node/any given node
...
//function to find distance btw 2
...
int main() {
    ...
    cout << "Dist btw 9 and 13 = " << findDistance(root, 9, 13);
