//Sort the string challenge (Que Below the code)
...
string extractStringAtKey(string str, int key){
    //strtok
    char *s = strtok((char *)str.c_str(), " ");     //this gives us the first token of any string

    //for key_th token for the given string
    while(key>1){
        s = strtok(NULL, " ");
        key--;
    } 
...
int main(){
    ...
    pair<string, string> strPair[100];      //store all the string along with their key
...
// In the i-th of the following n lines there is a string Si. 
//In the last line, there are 3 space-separated values, denoting the values of variables 'key','reversed' ,
// comparison-type.
